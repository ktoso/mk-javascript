app.core.Object.define("app.controller.Game", {
    ...
    member: {
		...
		run: function() {
            ...
            this.character = new app.controller.Character(new app.model.Character('character' + playerId++), new app.view.Character(), this, fsm, false);
            fsm.setCharacter(this.character);

            var fsm2 = new app.controller.Fsm(new app.model.Fsm());
            this.character2 = new app.controller.Character(new app.model.Character('character' + playerId++), new app.view.Character(), this, fsm2, true);
